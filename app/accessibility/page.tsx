      ...
      <div className="max-w-4xl mx-auto px-6 py-16">
        <div className="bg-white rounded-3xl p-8 md:p-12 border border-gray-200 shadow-lg">
          ...
          <div className="space-y-10 text-gray-900">
            ...
            <section>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  <h3 className="font-semibold mb-2 text-gray-900">Keyboard Navigation</h3>
                  <p className="text-sm text-gray-600">
                    Full keyboard accessibility for all interactive elements
                  </p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  <h3 className="font-semibold mb-2 text-gray-900">Screen Readers</h3>
                  <p className="text-sm text-gray-600">
                    Compatible with JAWS, NVDA, and VoiceOver
                  </p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  <h3 className="font-semibold mb-2 text-gray-900">Text Alternatives</h3>
                  <p className="text-sm text-gray-600">
                    Alt text for images and descriptive labels
                  </p>
                </div>
                <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                  <h3 className="font-semibold mb-2 text-gray-900">Color Contrast</h3>
                  <p className="text-sm text-gray-600">
            ...
            {/* Feedback */}
            <section className="bg-gradient-to-r from-sky-100 to-blue-100 rounded-xl p-6 border border-sky-300">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                <span className="text-3xl">💬</span>
                Feedback & Contact
              </h2>
              ...
              <div className="space-y-2">
                <p className="flex items-center gap-2">
                  ...
                  <a href="mailto:campusconnectcapstone@gmail.com" className="text-sky-600 hover:text-sky-700 break-all">
