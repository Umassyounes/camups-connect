      ...
      <section className="bg-white border-b border-gray-200 py-6 md:py-10">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-[#1A202C] mb-1">My Listings</h1>
              <p className="text-sm md:text-base text-[#718096]">Manage and track all your marketplace posts</p>
            </div>
            <Link 
              href="/listings/new"
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-6 py-6 md:py-8">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 md:p-12 text-center">
            <div className="text-4xl md:text-5xl mb-4">No items</div>
